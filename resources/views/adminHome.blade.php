                ...
                <div class="widget-content">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-7.jpg') }}" alt="avatar">Andy King</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-4.jpg') }}" alt="avatar">Irene Collins</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-10.jpg') }}" alt="avatar">Laurie Fox</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-13.jpg') }}" alt="avatar">Luke Ivory</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-5.jpg') }}" alt="avatar">Ryan Collins</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-6.jpg') }}" alt="avatar">Nia Hillyer</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{ asset('asset/assets/img/profile-11.jpg') }}" alt="avatar">Sonia Shaw</div></td>
                ...
                <div class="widget-content">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/speaker.jpg') }}" alt="product">Speakers</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/sunglass.jpg') }}" alt="product">Sunglasses</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/watch.jpg') }}" alt="product">Watch</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/laptop.jpg') }}" alt="product">Laptop</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/camera.jpg') }}" alt="product">Camera</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/shoes.jpg') }}" alt="product">Shoes</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{ asset('asset/assets/img/headphones.jpg') }}" alt="product">Headphone</div></td>
